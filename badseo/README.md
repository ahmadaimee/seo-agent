...
[S.E.O Agent](https://github.com/ahmadaimee/seo-agent) site audit. Every page lists the audit issues it
should trigger, and a harness runs the real audit engine against a running copy
to check that it does.

Maintained by the team behind [S.E.O Agent](https://github.com/ahmadaimee/seo-agent), an open-source SEO
tool.
...
Every issue type in the S.E.O Agent audit engine is exercised by at least one page
...
The harness drives the **real** S.E.O Agent crawl + issue-detection functions
