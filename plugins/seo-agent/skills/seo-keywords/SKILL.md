...
user-invocable: true
argument-hint: "<seed topic or domain>"
license: MIT
metadata:
  author: ahmadaimee
  version: "3.0.0"
...
# S.E.O Agent Keyword Research

## Goal

Turn seed topics into a prioritized keyword opportunity set using S.E.O Agent MCP data. The output should help the user decide what to target, what to save, and what to research next.
...
- Do not invent metrics. If S.E.O Agent does not return a value, write `unknown`.
