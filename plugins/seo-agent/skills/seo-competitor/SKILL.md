...
# S.E.O Agent Competitor Analysis

## Goal

Analyze one competitor deeply enough to decide what to learn from, avoid, counter-position against, or outrank.

Use this for a named competitor. For identifying the market leaders first, use `seo-landscape`.
...
| Area | Competitor pattern | Evidence | S.E.O Agent opportunity |
| ---- | ------------------ | -------- | ------------------- |
