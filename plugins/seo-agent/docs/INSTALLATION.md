...
```bash
git clone --depth 1 https://github.com/ahmadaimee/seo-agent.git
...
```bash
curl -fsSL https://raw.githubusercontent.com/ahmadaimee/seo-agent/main/install.sh > install.sh
...
```
/plugin uninstall claude-seo@ahmadaimee-claude-seo
/plugin marketplace remove ahmadaimee/seo-agent
```
...
curl -fsSL https://raw.githubusercontent.com/ahmadaimee/seo-agent/main/uninstall.sh | bash

# Install new version
curl -fsSL https://raw.githubusercontent.com/ahmadaimee/seo-agent/main/install.sh | bash
```
