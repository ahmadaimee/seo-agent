      ...
      {treatment === "simple" && (
        <>
          <div className="mb-5 flex items-center justify-between gap-3">
            <span className="text-sm font-medium">S.E.O Agent plugin</span>
        ...
        <>
          <div className="overflow-hidden rounded-xl border border-base-300">
            <div className="flex items-center justify-between gap-3 border-b border-base-300 bg-base-200/40 px-5 py-3.5">
              ...
              <span className="text-xs text-base-content/45">S.E.O Agent</span>
            </div>
            <div className="p-5">
              <p className="text-sm font-medium">
                Set up S.E.O Agent in this agent.
              </p>
