...
const projectPrompt = `Use S.E.O Agent to set up a separate project for each website below. List my existing projects first and reuse matches so you don’t create duplicates. Set the country and language for each site, and ask me about anything missing.
    ...
    return (
      <div className="max-w-2xl space-y-4">
        ...
        <div className="flex flex-col gap-4 rounded-lg border border-base-300 bg-base-200/25 p-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-medium">S.E.O Agent plugin</p>
        ...
        <a
          href="https://github.com/ahmadaimee/seo-agent/blob/main/docs/mcp"
          target="_blank"
          rel="noreferrer"
