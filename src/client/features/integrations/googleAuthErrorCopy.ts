    ...
    case "account_already_linked_to_different_user":
      return {
        ...
        description: providerLabel
          ? `Sign in to the S.E.O Agent user that linked it, open the ${providerLabel} property picker, and choose Remove account beside the Google account. Then link it here.`
          : "That Google account is already linked to a different S.E.O Agent user. Sign in with that user, or contact support for help.",
      };
    default:
      return {
        title: `${what} didn't finish`,
