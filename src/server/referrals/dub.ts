...
//  1. links.github.com/ahmadaimee/seo-agent/<partner> redirects to github.com/ahmadaimee/seo-agent/?dub_id=<clickId>;
//     the marketing site persists it as a `dub_id` cookie on `.github.com/ahmadaimee/seo-agent`.
