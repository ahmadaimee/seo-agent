  ...
  const form = useForm({
    ...
    onSubmit: async ({ formApi, value }) => {
      ...
      try {
        ...
        const resolvedName =
          value.name.trim() || email.split("@")[0] || "S.E.O Agent User";
          ...
          showEmailForm ? (
            ...
            <div className="space-y-4">
              <p className="text-sm leading-relaxed text-base-content/60">
                ...
                <a
                  href="https://github.com/ahmadaimee/seo-agent/terms-and-conditions"
                  target="_blank"
                  rel="noreferrer"
                ...
                and{" "}
                <a
                  href="https://github.com/ahmadaimee/seo-agent/privacy"
                  target="_blank"
                  rel="noreferrer"
                  className="text-base-content underline underline-offset-2 hover:text-base-content/80 transition-colors"
                >
