...
const SAM_GITHUB_URL = "https://github.com/ahmadaimee/sam";
const SKILL_NAMES = [
  "seo-project-setup",
  "seo-coach",
  "keyword-research",
...
const SKILLS_INSTALL = `npx skills add ahmadaimee/seo-agent`;
const ALL_SKILLS_INSTALL = `npx skills add ahmadaimee/seo-agent --skill '*'`;
const CLAUDE_CODE_SKILLS_INSTALL = `npx skills add ahmadaimee/seo-agent --skill '*' --agent claude-code`;
const CODEX_SKILLS_INSTALL = `npx skills add ahmadaimee/seo-agent --skill '*' --agent codex`;
const SKILLS_MANUAL_INSTALL = `git clone https://github.com/ahmadaimee/seo-agent.git

# Codex
mkdir -p ~/.codex/skills
cp -R seo-agent/plugins/seoagent/skills/* ~/.codex/skills/

# Claude Code
mkdir -p ~/.claude/skills
cp -R seo-agent/plugins/seoagent/skills/* ~/.claude/skills/`;
      ...
      <div className="mx-auto max-w-3xl">
        ...
        {getAuthMode(import.meta.env.AUTH_MODE) === "cloudflare_access" ? (
          <div className="alert alert-warning mt-6 text-sm" role="alert">
            ...
            <span>
              ...
              <a
                href="https://github.com/ahmadaimee/seo-agent/blob/main/docs/self-hosting/cloudflare#connect-the-mcp-server-through-cloudflare-access"
                target="_blank"
                rel="noreferrer"
        ...
        <section className="mt-8">
          ...
          <p className="mt-2.5 text-xs text-base-content/55 leading-relaxed">
            Paste this into any MCP client. This URL points at the S.E.O Agent
            instance you are using now, whether hosted, self-hosted, or local.
            Sign in with S.E.O Agent when prompted.
          </p>
        ...
        <section className="mt-10">
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              ...
              <CodeBlock
                code={`claude mcp add --transport http --scope user seoagent ${mcpUrl}`}
                onCopy={() =>
            ...
            >
              <ol className="ml-5 list-decimal space-y-1.5 text-sm text-base-content/70 leading-relaxed">
                ...
                <li>Approve the S.E.O Agent login when prompted.</li>
                <li>
                  Optional: after S.E.O Agent connects, click{" "}
                  <span className="font-medium text-base-content">
                    Configure
                  </span>
                  , then choose{" "}
            ...
            >
              ...
              <CodeBlock
                code={`codex mcp add seoagent --url ${mcpUrl}`}
                onCopy={() =>
                  captureClientEvent("mcp:setup_command_copy", {
                    agent: "codex",
                  })
        ...
        <section className="mt-12">
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              ...
              <p className="text-sm text-base-content/70">
                You can also auto-accept each S.E.O Agent skill:
              </p>
            ...
            {[
              {
                ...
                description:
                  "Ask questions and run research without leaving S.E.O Agent",
              },
              {
