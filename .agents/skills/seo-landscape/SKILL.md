...
# S.E.O Agent Competitive Landscape

## Goal

Answer: "Who is winning this SEO market, what content is working for them, and where are the openings?"

Use this when the user wants a market-level view across several competitors. For a deep dive on one domain, use `seo-competitor`.
...
- Do not overstate exact traffic when S.E.O Agent returns estimates.
