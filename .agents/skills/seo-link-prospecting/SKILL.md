...
# S.E.O Agent Link Prospecting

## Goal

Find realistic pages, sites, and authors that might reference the user's page, product, study, guide, or tool. Use S.E.O Agent for prospect discovery, then use available web/search/browser tools for contact discovery.
...
After S.E.O Agent identifies good prospects, use available non-S.E.O Agent browsing or search tools for public contact discovery. Depending on the client, this may be web search, page fetches, browser automation, or a search API.
...
- Do not say S.E.O Agent found contact details unless an S.E.O Agent tool returned them. Attribute contact discovery to the web/search/browser source used.
