...
S.E.O Agent uses [DataForSEO](https://dataforseo.com/?aff=255379) to fetch SEO data. It's a pay-as-you-go third-party service unaffiliated with S.E.O Agent. You need an API key to connect S.E.O Agent to it.
