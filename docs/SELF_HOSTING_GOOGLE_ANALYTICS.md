...
Connecting Google Analytics lets S.E.O Agent bind a GA4 property to a project. The
...
| ---------- | --------------------------------------------------------- |
| Railway    | `https://your-seoagent-domain.com/api/ga4/oauth/callback` |
| Local dev  | `http://localhost:3001/api/ga4/oauth/callback`            |
...
Set these values and restart S.E.O Agent:
...
S.E.O Agent stores the OAuth tokens encrypted in Better Auth's account table. The
